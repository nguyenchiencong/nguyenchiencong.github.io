...
I've set up AI assistants for coding in Vscode. I use continue.dev for assistance in writing. I use Claude-Code as my main orchestrator, distributing tasks to sub-agents such as OpenCode (Kimi, Minimax, and GLM models), Gemini-CLI, and Qwen-CLI for semi-autonomous assisted coding. I also use Codex (ChatGPT) for final code review, debugging, and planning. Handling AI models and coding agents feels like collecting and handling pokemons.